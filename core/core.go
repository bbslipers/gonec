...
func Import(env *Env) *Env {
	env.DefineS("длина", VMFuncOneParam[VMIndexer](func(args VMSlice, rets *VMSlice) error {
	...
	env.DefineS("окр", VMFuncTwoParams[VMDecNum, VMInt](func(args VMSlice, rets *VMSlice) error {
